...
pub(crate) static ATTRIBUTES: phf::Map<&'static str, AttributeTag> = phf::phf_map! {
    ...
    "TAGame.Ball_TA:ReplicatedExplosionDataReactive" => AttributeTag::FlaggedByte,
    ...
    "TAGame.GameEvent_TA:DemoFXOverride" => AttributeTag::ActiveActor,
    ...
    "TAGame.PRI_TA:BallDemolitions" => AttributeTag::Int,
    "TAGame.PRI_TA:BallDemolitionSaves" => AttributeTag::Int,
    "TAGame.PRI_TA:BallTouches" => AttributeTag::Int,
    "TAGame.PRI_TA:bAnonymizeToOpponents" => AttributeTag::Boolean,
    "TAGame.PRI_TA:bAnonymizeToTeammates" => AttributeTag::Boolean,
    "TAGame.PRI_TA:bEligibleForHonorDuels" => AttributeTag::Boolean,
    ...
    "TAGame.PRI_TA:BoostPickups" => AttributeTag::Int,
    ...
    "TAGame.PRI_TA:CarTouches" => AttributeTag::Int,
    ...
    "TAGame.PRI_TA:Dodges" => AttributeTag::Int,
    "TAGame.PRI_TA:EpicPUID" => AttributeTag::String,
    "TAGame.PRI_TA:EquippedTitleStatValue" => AttributeTag::Int,
    "TAGame.PRI_TA:KeepUpClears" => AttributeTag::Int,
    "TAGame.PRI_TA:KeepUpDenials" => AttributeTag::Int,
    "TAGame.PRI_TA:KeepUpPossessions" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchAerialHits" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchAssists" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchBicycleHits" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchBreakoutDamage" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchCenters" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchClears" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchCrossbarHits" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchDemolishes" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchEpicSaves" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchFirstTouches" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchFlipResets" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchGoals" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchHighFives" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchJuggleHits" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchLowFives" => AttributeTag::Int,
    "TAGame.PRI_TA:MatchPoolShots" => AttributeTag::Int,
    ...
    "TAGame.PRI_TA:MatchTimesDemolished" => AttributeTag::Int,
    ...
    "TAGame.PRI_TA:PlayerStatus" => AttributeTag::Byte,
    ...
    "TAGame.PRI_TA:PowerUpsUsed" => AttributeTag::Int,
